            ...
            <yd-tab-panel class="comment" label="买家评论">
                <ul>
                    <li v-for="(item, index) in comment" :key="index">
                        ...
                        <p style="padding-left:40px">{{ item.ctime }}  &nbsp;&nbsp;&nbsp;&nbsp;{{ item.addon }}</p>
                        <p style="padding-left:40px">{{ item.content }}</p>
                            <yd-lightbox class="comment-imgs" style="padding-left:40px">
...
export default {
    ...
    methods: {
        ...
        // 加入购物车
        add () {
            // this.$dialog.toast({mes:'级别不够，不能操作',timeout:1000})
