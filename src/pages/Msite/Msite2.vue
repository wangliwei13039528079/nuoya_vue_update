        ...
        <div class="miste-conent">
            ...
            <div class="swiper-notice">
                <div class="swiper-wrapper">
                    <a class="swiper-slide" v-for="(item,index) in notice" :key="index">
                        ...
                        <span style="color:#abc2e2">{{item.title}}</span>
                    </a>
                </div>
            ...
            <div class="ranking-box">
                <div class="top-title">
                    ...
                    <span style="color:#abc2e2">行情</span>
                </div>
                <!--排行列表 开始-->
                ...
                <div class="coin"  v-for="(item,index) in bbmarket" :key="index">
                    <div class="coin_type">
                        ...
                        <div>
                            <p class="coin_f">{{item.molecule}} <span style="color:#728bd9;font-size:14px">{{item.denominator}}</span></p>
                            <p style="color:#728bd9">{{item.volume}}</p>
                        </div>
                    </div>
                    <div class="coin_price">
                        <p class="coin_f">${{parseInt(item.usd*10000)/10000}}</p>
                        <p style="color:#728bd9">￥{{parseInt(item.cny*100)/100}}</p>
                    </div>
...
<style lang="less">
    #Msite {
        ...
        .coin {
            ...
            .float_down {
                background-color:rgba(45,178,73,.6);
            }
            .coin_price {
                flex: 1;
                text-align: right;
