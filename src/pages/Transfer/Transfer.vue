        ...
        <div class="" style="padding: 10px">
            ...
            <div class="content">
                ...
                <select name="" id="option" ref="options">
                    ...
                    <option value="1">静态释放</option>
                    <option value="2">分享加速</option>
                    <option value="3">共享加速</option>
                </select>
            </div>
            <!-- <div class="content">
            ...
            <div class="btn-group">
                <van-button size="large" type="primary" @click="showKeyboard = true"  style="background-color:#161616; border: none;color:#fff">确定转换</van-button>
        ...
        methods: {
            ...
            onInput (key) {
                ...
                if (this.value.length == 6) {
                    ...
                    this.value = ''
                    if(!type) {
                       return this.$dialog.toast({mes: '请选择转换类型', timeout: 1000})
                    }
                    if(num.length < 1) {
                        return this.$dialog.toast({mes: '请输入数量', timeout: 1000})
                    }
                    this.$api.outTransfer(data,res=>{
                        if(res) {
