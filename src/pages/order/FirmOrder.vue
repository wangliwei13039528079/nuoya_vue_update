<template>
    <div class="firmorder">
        ...
        <div class="ordercoupon">
            ...
            <yd-popup v-model="couponShow" position="bottom" height="40%" background="#000" class="ordercoupon-content">
    ...
    methods: {
        ...
        payment () {
            ...
            this.$api.createOrder(data, res => {
                if (res.status) {
                    this.$router.replace({path: '/cashierdesk', query: {order_id: res.data.order_id, type: 1}})
                }
            })
        },
        // 门店自提 联系人,联系方式
...
<style scoped>
    ...
    .firmorder .yd-cell-item:not(:last-child):after {
        width: 0;
    }
    /deep/.firmorder .yd-cell:after {
        width: 0 !important;
    }
</style>
