<template>
    <div class="user">
        ...
        <yd-cell-group>
            <yd-cell-item arrow>
                <img slot="icon" src="../../static/image/orderform.png">
                <span slot="left">商铺区订单</span>
                <router-link slot="right" tag="span" to="/MerchantAllorder">查看全部订单</router-link>
            </yd-cell-item>
            <yd-grids-group :rows="3">
                <yd-grids-item :link="{path: '/MerchantAllorder', query: {tab: 1}}">
                    <img slot="icon" src="../../static/image/unpaid.png">
                    <span slot="text">待付款</span>
                </yd-grids-item>
                <yd-grids-item :link="{path: '/MerchantAllorder', query: {tab: 2}}">
                    <img slot="icon" src="../../static/image/pendingdelivery.png">
                    <span slot="text">待发货</span>
                </yd-grids-item>
                <yd-grids-item :link="{path: '/MerchantAllorder', query: {tab: 3}}">
                    <img slot="icon" src="../../static/image/shipped.png">
                    <span slot="text">待收货</span>
                </yd-grids-item>
                <!-- <yd-grids-item link="/allafterservice">
        ...
        <yd-cell-group>
            ...
            <yd-cell-item href="/ApplyMerchant" type="link" v-if="user.merchant == 0 || user.merchant == 3">
                <img slot="icon" src="../../static/image/me-ic-site.png">
                <span slot="left">申请成为商户</span>
                <p slot="right" v-if="user.merchant == 3" style="color:#fff">已被拒绝，重新申请</p>
            </yd-cell-item>
            <yd-cell-item v-if="user.merchant == 1">
                <img slot="icon" src="../../static/image/me-ic-site.png">
                <span slot="left">申请成为商户</span>
                <p slot="right" style="color:#fff">审核中</p>
            </yd-cell-item>
             <yd-cell-item href="/MerchantManage" type="link" v-if="user.merchant == 2">
                <img slot="icon" src="../../static/image/me-ic-site.png">
                <span slot="left">商户管理入口</span>
            </yd-cell-item>
            <!-- <yd-cell-item href="/key" type="link">
                <img slot="icon" src="../../static/image/remainingsum.png">
                <span slot="left">获取私钥</span>
            </yd-cell-item> -->
        </yd-cell-group>
        <yd-cell-group>
