...
let methodToken = [
    ...
    'merchant.add_goods',
    'merchant.user_list',
    'merchant.merchant_goods',
    'merchant.goods_list',
    'merchant.status_true',
    'merchant.goods',
    'merchant.pay_order',
    'merchant.add_order',
    'user.pay_pwd',
    'merchant.order_list',
    'merchant.order',
    'merchant.merchant_order_list',
    'merchant.merchant_address',
    'merchant.receiving',
    'user.set_mobile',
    'user.ppa_list',
    'user.ppa_add_order',
    'user.ppa_release_order',
    'user.licai_list',
    'user.get_repayment',
    'user.set_repayment',
    'user.set_borrow',
...
const post = (method, data, callback) => {
    ...
    data.method = method
    let language = common.getStorage('language')
    let lang
    if (language == 'zh') {
        lang = 'zh-cn'
    } else if (language == 'en') {
    ...
    sendPost(apiUrl + '?lang=' + lang, qs.stringify(data), {}, callback)
}
...
export const shopConfig = () => axios.get(url.replace('api.html','') + '/api/common/jshopconf').then(response => response.data)
export const getKline = (url) =>axios.get( process.env.GO_API + url).then(response => response)
// 用户注册
export const reg = (data, callback) => post('user.reg', data, callback)
export const zxline = (data, callback) => post('user.zxline', data, callback)
export const homeIndex = (data, callback) => post('user.homeIndex', data, callback)
...
export const identityauth = (data, callback) => post('user.identityauth', data, callback)

export const identityauthstatus = (data, callback) => post('user.identityauthstatus', data, callback)
...
// 推荐注册
export const register = (data, callback) => post('user.reg', data, callback)

// 转账
export const userTransfer = (data, callback) => post('user.transfer', data, callback)

// 资金转换
export const outTransfer = (data, callback) => post('wallet.transfer', data, callback)

// 流水账单
export const transferBill = (data, callback) => post('user.money_list', data, callback)

// 矿机模块API
// 购买矿机
export const buyMill = (data, callback) => post('mine.buymine', data, callback)

// 矿机列表
export const millList = (data, callback) => post('mine.minelist', data, callback)

export const applyOutb = (data, callback) => post('wallet.applyOutb', data, callback)
export const applyOut = (data, callback) => post('wallet.applyOut', data, callback)
// 矿机升级
export const millUp = (data, callback) => post('mine.mineup', data, callback)

// 单个矿机详情
export const single = (data, callback) => post('mine.single', data, callback)

// 矿机收益
export const millProfit = (data, callback) => post('mine.produce', data, callback)

// 首页数据
export const reqHomePage = (data, callback) => post('mine.index', data, callback)

// 用户资产
export const userWallet = (data, callback) => post('user.money', data, callback)

// 添加支付方式
// export const addPay = (data, callback) => post('trade.addPay', data, callback)

export const addPay = (data, callback) => {
    let userToken = common.getStorage('user_token')
    data.append('method', 'trade.addPay')
...
// 更改二级密码 user.editpay
export const editpay = (data, callback) => post('user.editpay', data, callback)

/// o2c/coinList 获取币种
// export const reqcoinList = (data, callback) => post('otc.coin', data, callback)

// OTC查看挂单
export const reqorderlist = (data, callback) => post('otc.orderlist', data, callback)

// 首页显示 notice.noticeList
export const reqnoticeList = (data, callback) => post('notice.noticeList', data, callback)

// coin.index   获取首页数据
export const reqindex = (data, callback) => post('home.index', data, callback)

// 获取首页实时行情
export const bbmarketList = (data, callback) => post('mine.bbmarket_list', data, callback)

// 获取文章
export const articles = (data, callback) => post('articles.getArticleList', data, callback)

// 获取版本号
export const version = (data, callback) => post('user.app_edition', data, callback)

// 获取客服消息
export const message = (data, callback) => post('user.pointsedit', data, callback)

// 发送消息
export const addMsg = (data, callback) => post('user.msg', data, callback)

// 上传图片通用接口
export const uploadImg = (data, callback) => {
    let userToken = common.getStorage('user_token')
    data.append('method', 'user.add_img')
    data.append('token', userToken)
    let param = {
        headers: { 'Content-Type': 'multipart/form-data' }
    }
...
// 修改登录密码
export const editPwd = (data, callback) => post('user.mpwd', data, callback)

// 修改支付密码
export const editPayPwd = (data, callback) => post('user.mppwd', data, callback)

// 重置登录密码
export const forgetPwd = (data, callback) => post('user.cz_mpwd', data, callback)

// 重置支付密码
export const forgetPayPwd = (data, callback) => post('user.cs_mppwd', data, callback)

// 抢购
export const RobBuy = (data, callback) => post('user.eosv', data, callback)

// eosv抢购页面信息
export const eosvNum = (data, callback) => post('user.eosv_list', data, callback)

// 抢购记录
export const robLog = (data, callback) => post('user.eosv_lists', data, callback)

// 商户上传图片
export const merchantUploadFile = (data, callback) => {
    let userToken = common.getStorage('user_token')
    data.append('method', 'merchant.add_img')
    data.append('token', userToken)
    let param = {
        headers: { 'Content-Type': 'multipart/form-data' }
    }
...
// 申请成为商户
export const addMerchant = (data, callback) => post('merchant.add_merchant', data, callback)

// 获取产品分类
export const productClassify = (data, callback) => post('merchant.cate_list', data, callback)

// 上架商品
export const uploadMerchant = (data, callback) => post('merchant.add_goods', data, callback)

// 我的商品
export const myCommodity = (data, callback) => post('merchant.user_list', data, callback)

// 我的商品详情
export const myCommodityDetail = (data, callback) => post('merchant.merchant_goods', data, callback)

// 商家区商品
export const selfSupportGoods = (data, callback) => post('merchant.goods_list', data, callback)

// 修改产品上下架
export const editProStatus = (data, callback) => post('merchant.status_true', data, callback)

// 商品详情
export const selfSupportGoodsDetail = (data, callback) => post('merchant.goods', data, callback)

// 创建订单
export const merchantCreatedOrder = (data, callback) => post('merchant.add_order', data, callback)

// 支付订单
export const merchantPayOrder = (data, callback) => post('merchant.pay_order', data, callback)

// 批发商品支付密码
export const retailPayPwd = (data, callback) => post('user.pay_pwd', data, callback)

// 商户区购买商品列表
export const merchantOrders = (data, callback) => post('merchant.order_list', data, callback)

// 查看订单详情
export const merchantOrderInfo = (data, callback) => post('merchant.order', data, callback)

// 我的商铺订单
export const shopsOrders = (data, callback) => post('merchant.merchant_order_list', data, callback)

// 商家发货
export const deliverGoods = (data, callback) => post('merchant.merchant_address', data, callback)

// 用户确认收货
export const receivingGoods = (data, callback) => post('merchant.receiving', data, callback)
export const userSetMobile = (data, callback) => post('user.set_mobile', data, callback)

export const userPpaList = (data, callback) => post('user.ppa_list', data, callback)

export const userPpaAddOrder = (data, callback) => post('user.ppa_add_order', data, callback)
export const userPpaReleaseOrder = (data, callback) => post('user.ppa_release_order', data, callback)
export const payPwd = (data, callback) => post('user.pay_pwd', data, callback)

export const userLicai_list = (data, callback) => post('user.licai_list', data, callback)
export const userGet_repayment = (data, callback) => post('user.get_repayment', data, callback)
export const userSet_repayment = (data, callback) => post('user.set_repayment', data, callback)
export const userSet_borrow = (data, callback) => post('user.set_borrow', data, callback)
export const userGet_borrow = (data, callback) => post('user.get_borrow', data, callback)
export const userBorrow_list = (data, callback) => post('user.borrow_list', data, callback)

export const shopList = (data, callback) => post('merpor.index', data, callback)

export const reqKdata = (data, callback) => post('kline.getkdata', data, callback)

export const reqKdataItem = (data, callback) => post('kline.getlast', data, callback)

export const reqOceanIndex = (data, callback) => post('ocean.index', data, callback)
export const reqOceanlicai = (data, callback) => post('ocean.ocean_licai', data, callback)
export const reqOceanlicailist = (data, callback) => post('ocean.licai_list', data, callback)
export const reqOceanharvest = (data, callback) => post('ocean.harvest', data, callback)

export const coinPrice = (data, callback) => post('user.coinprice', data, callback)

export const biliCreateOrder = (data, callback) => post('bili.createOrder', data, callback)
export const biliGetBiliInfo = (data, callback) => post('bili.getBiliInfo', data, callback)
export const getOrderLists = (data, callback) => post('bili.getOrderList', data, callback)
export const getLastEntrust = (data, callback) => post('bili.getLastEntrust', data, callback)
export const backOrder = (data, callback) => post('bili.backOrder', data, callback)

export const signIn = (data, callback) => post('user.signIn', data, callback)
export const network = (data, callback) => post('user.network', data, callback)
